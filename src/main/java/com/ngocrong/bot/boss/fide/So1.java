...
public class So1 extends Boss {
    ...
    private final static Logger logger = Logger.getLogger(So1.class);

    private final GinyuForce team;

    public So1(GinyuForce team) {
        super();
        this.team = team;
...
//        killer.isChangePoint = true;
        if (killer.taskMain != null && killer.taskMain.id == 20 && killer.taskMain.index == 4
