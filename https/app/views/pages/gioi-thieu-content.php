<div class="bg-content">
            ...
            <!-- <p style="text-align:center"><a href="https://ngocrongonline.com/?c=skill" style="color:red;">Danh sách các kỹ năng</a></p> -->
            ...
            <div style='max-width: 620px;height: 384px;'>
                <div class='parent'>
                    <div class='slider'>
          ...
          c2.6,2.6,6.1,4,9.5,4s6.9-1.3,9.5-4c5.3-5.3,5.3-13.8,0-19.1L145.188,238.575z" />
            ...
            <p style="text-align:center"><strong><img alt="" src="assets/images/screen/2-10.png" style="max-width:100%"></strong></p>
            ...
            <p id='slider-2.1' class="" style="text-align:center"><img alt="" src="assets/images/screen/2-1.png" style="width:100% !important"></p>
            <p id='slider-2.2' style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-2.png" style="width:100% !important"></p>
            <p id='slider-2.3' style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-3.png" style="width:100% !important"></p>
            <p id='slider-2.4' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-4.png" style="width:100% !important"></p>
            <p id='slider-2.5' style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-5.png" style="width:100% !important"></p>
            <p id='slider-2.6' style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-6.png" style="width:100% !important"></p>
            <p id='slider-2.7' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-7.png" style="width:100% !important"></p>
            <p id='slider-2.8' style="text-align:center;display:none"><img alt="" src="assets/images/screen/2-8.png" style="width:100% !important"></p>
            <div class='text-center'>
                <a id='slider-2.1a' onclick="slider2a(1)" class="active-2 carousel-2" href="javascript:void(0)">1</a>
                <a id='slider-2.2a' onclick="slider2a(2)" href="javascript:void(0)" class='carousel-2'>2</a>
                <a id='slider-2.3a' onclick="slider2a(3)" href="javascript:void(0)" class='carousel-2'>3</a>
                <a id='slider-2.4a' onclick="slider2a(4)" href="javascript:void(0)" class='carousel-2'>4</a>
                <a id='slider-2.5a' onclick="slider2a(5)" href="javascript:void(0)" class='carousel-2'>5</a>
                <a id='slider-2.6a' onclick="slider2a(6)" href="javascript:void(0)" class='carousel-2'>6</a>
                <a id='slider-2.7a' onclick="slider2a(7)" href="javascript:void(0)" class='carousel-2'>7</a>
                <a id='slider-2.8a' onclick="slider2a(8)" href="javascript:void(0)" class='carousel-2'>8</a>
            </div>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/4-1.png" style="max-width:100%"></p>
            <p>*Trái đất có các chiêu thức huyền thoại điển hình như: Quả cầu kênh khi, Kaioken, Trái dương hạ san, Kamejoko</p>
            <p style="text-align:center"><img alt="" src="assets/images/screen/4-2.png" style="max-width:100%"></p>
            <p>*Namếc có các chiêu thức huyền thoại điển hình như: Makankosappo, Đẻ trứng, Trị thương</p>
            <p style="text-align:center"><img alt="" src="assets/images/screen/4-3.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/5-1.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/5-2.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/5-3.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/6-1.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/6-2.png" style="max-width:100%"></p>
            <p style="text-align:center"><img alt="" src="assets/images/screen/6-3.png" style="max-width:100%"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/7-1.png"></p>
            ...
            <p style="text-align:center"><strong><img alt="" src="assets/images/screen/8-2.png"></strong></p>
            ...
            <p style="text-align:center"><strong><img alt="" src="assets/images/screen/8-3.png"></strong></p>
            ...
            <p style="text-align:center"><strong><img alt="" src="assets/images/screen/8-4.png"></strong></p>
            <p style='color: #012699;'><strong>9. Ra mắt các võ đài</strong></p>
            <ul>
                <li>Đại Hội Võ Thuật</li>
            </ul>
            <p style="text-align:center"><img alt="" src="assets/images/screen/9-1.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/9-2.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/9-3.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/9-4.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/9-5.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/10-1.png"></p>
            <p>Bao gồm 4 loại:<br>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/11-2.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/11-3.png"></p>
            ...
            <p style="text-align:center"><img alt="" src="assets/images/screen/11-4.png"></p>
            ...
            <p id='slider-13.1' class="" style="text-align:center"><img alt="" src="assets/images/screen/12-1.png" style="width:100% !important"></p>
            <p id='slider-13.2' style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-2.png" style="width:100% !important"></p>
            <p id='slider-13.3' style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-3.png" style="width:100% !important"></p>
            <p id='slider-13.4' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-4.png" style="width:100% !important"></p>
            <p id='slider-13.5' style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-5.png" style="width:100% !important"></p>
            <p id='slider-13.6' style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-6.png" style="width:100% !important"></p>
            <p id='slider-13.7' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/12-7.png" style="width:100% !important"></p>
            <div class='text-center'>
                <a id='slider-13.1a' onclick="slider13(1)" class="active-2 carousel-2" href="javascript:void(0)">1</a>
                <a id='slider-13.2a' onclick="slider13(2)" href="javascript:void(0)" class='carousel-2'>2</a>
                <a id='slider-13.3a' onclick="slider13(3)" href="javascript:void(0)" class='carousel-2'>3</a>
                <a id='slider-13.4a' onclick="slider13(4)" href="javascript:void(0)" class='carousel-2'>4</a>
                <a id='slider-13.5a' onclick="slider13(5)" href="javascript:void(0)" class='carousel-2'>5</a>
                <a id='slider-13.6a' onclick="slider13(6)" href="javascript:void(0)" class='carousel-2'>6</a>
                <a id='slider-13.7a' onclick="slider13(7)" href="javascript:void(0)" class='carousel-2'>7</a>
            </div>
            ...
            <p id='slider-14.1' class="" style="text-align:center"><img alt="" src="assets/images/screen/14-1.png" style="width:100% !important"></p>
            <p id='slider-14.2' style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-2.png" style="width:100% !important"></p>
            <p id='slider-14.3' style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-3.png" style="width:100% !important"></p>
            <p id='slider-14.4' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-4.png" style="width:100% !important"></p>
            <p id='slider-14.5' style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-5.png" style="width:100% !important"></p>
            <p id='slider-14.6' style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-6.png" style="width:100% !important"></p>
            <p id='slider-14.7' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-7.png" style="width:100% !important"></p>
            <p id='slider-14.8' class="" style="text-align:center;display:none"><img alt="" src="assets/images/screen/14-8.png" style="width:100% !important"></p>

            <div class='text-center'>
                <a id='slider-14.1a' onclick="slider14(1)" class="active-2 carousel-2" href="javascript:void(0)">1</a>
                <a id='slider-14.2a' onclick="slider14(2)" href="javascript:void(0)" class='carousel-2'>2</a>
                <a id='slider-14.3a' onclick="slider14(3)" href="javascript:void(0)" class='carousel-2'>3</a>
                <a id='slider-14.4a' onclick="slider14(4)" href="javascript:void(0)" class='carousel-2'>4</a>
                <a id='slider-14.5a' onclick="slider14(5)" href="javascript:void(0)" class='carousel-2'>5</a>
                <a id='slider-14.6a' onclick="slider14(6)" href="javascript:void(0)" class='carousel-2'>6</a>
                <a id='slider-14.7a' onclick="slider14(7)" href="javascript:void(0)" class='carousel-2'>7</a>
                <a id='slider-14.8a' onclick="slider14(8)" href="javascript:void(0)" class='carousel-2'>8</a>
