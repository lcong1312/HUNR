...
<div class="download">
                <div class="bg-content text-center">
                    <div class="download-actions">
                        <a class="download-actions__link" href="<?= e($pcDownload) ?>" download="Chú bé rồng.zip" title="Tải bản PC Windows">
                            <img height="35" src="assets/images/pc.png" alt="PC Windows">
                        </a>
            ...
            <div class="bg-content">
                <div>
                    ...
                    <div class="content">
                        ...
                        <p class="text-center">
                            <img alt="" src="assets/images/gif/gif_maphongba_VIP.gif">&nbsp;
                            <img alt="" src="assets/images/gif/gif_gif_Saiyain_VIP.gif">&nbsp;
                            <img alt="" src="assets/images/gif/gif_supber_kame_VIP.gif">&nbsp;
                        </p>
                        <p class="text-center">
                            <a href="https://ngocrongonline.com/?c=skill">Xem thêm</a>
                        </p>
                    </div>
                </div>
            </div>
